...
enum 
{
  F1_KEY=0xc0,F2_KEY,F3_KEY,F4_KEY,F5_KEY,F6_KEY,F7_KEY,F8_KEY,F9_KEY,F10_KEY,F11_KEY,F12_KEY,
  HOME_KEY,UP_KEY,PAGE_UP_KEY,LEFT_KEY,RIGHT_KEY,END_KEY,DOWN_KEY,PAGE_DOWN_KEY,INSERT_KEY,DELETE_KEY
};

enum
{ 
  LEFT_CONTROL_KEY=0xd6,LEFT_SHIFT_KEY,RIGHT_SHIFT_KEY,LEFT_ALT_KEY,CAPS_LOCK_KEY,
